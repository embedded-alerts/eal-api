...
- **No multi-line values.** Store PEM material as a single-line value whose
  newlines are represented by literal `\n` escapes; never paste private key
  material into documentation or committed plaintext examples.
